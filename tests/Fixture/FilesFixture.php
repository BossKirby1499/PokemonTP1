...
class FilesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'status' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '1', 'comment' => '1 =  active 0 = desactive', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-09-16 13:18:31',
                'modified' => '2019-09-16 13:18:31',
                'status' => 1
            ],
        ];
        parent::init();
